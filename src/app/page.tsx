        ...
        <div className="max-w-2xl px-8 py-12 bg-white border border-gray-300 rounded-2xl shadow-sm">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 ">
              ...
              <Link href="/login" className="rounded-xl bg-white hover:bg-gray-50 text-sm font-semibold px-3.5 py-2.5  border border-gray-300 leading-6 text-gray-900 w-full sm:w-auto">
                Login
              </Link>
            </div>
          </div>
